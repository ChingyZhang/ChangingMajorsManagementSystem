...
namespace ChangingMajors.DAL.Model
{
    public class UserModel
    {
        ...
        /// 文理科,0文,1理
        /// </summary>
        public int? UserArtsScience { get; set; }

        ///// <summary>
        ///// 用户英语等级,0无,4四级,6六级,8专八
        ///// </summary>
        //public int? UserEnglishPower { get; set; }

        public String UserEnglishFour { get; set; }

        public String UserEnglishSix { get; set; }
        ...
        /// 是否同意降级,0不同意,1同意
        /// </summary>
        public int? UserDemotion { get; set; }

        /// <summary>
        /// 不及格课程,0没有,1有
        /// </summary>
        public int? UserFiledClass { get; set; }

        /// <summary>
        /// 是否有纪律处分,0没有,1有
        /// </summary>
        public int? UserDisciplinaryAward { get; set; }
        ...
        /// 拟转专业ID
        /// </summary>
        public String SysMajorID { get; set; }
